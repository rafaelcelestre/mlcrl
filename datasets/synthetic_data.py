...
if __name__ == '__main__':
    ...
    p.add_argument('-l', '--lens', dest='lens', metavar='NUMBER', default=0, type=int, help='0 for ideal lens; 1 for aberrated lens')
    ...
    if args.illum == 0:
        oePlaneIllumination = SRWLOptL(_Fx=Rx, _Fy=Ry)
    ...
    f_CRL = R/(2*args.delta*nCRL) + ((nCRL-1)*ContainerThickness)/6
