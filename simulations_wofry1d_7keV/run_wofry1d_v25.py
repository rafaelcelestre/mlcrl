...
if __name__ == "__main__":
    ...
    dir = "/scisoft/users/srio/MLCRL/V25/sampled_profiles/"   # where the profile files sit
    dir_out = "/scisoft/users/srio/MLCRL/V25/wofry_results/" # where the results are going to be written
