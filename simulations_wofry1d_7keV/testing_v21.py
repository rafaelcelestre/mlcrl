...
if __name__ == "__main__":
    ...
    # nbin = 1
    # pstart = 100
    dir_files = "/scisoft/users/srio/MLCRL/V20/ML_TRAIN_V20_25000/" # profiles
    dir_wofrydata = "/scisoft/users/srio/MLCRL/V20/ML_TRAIN2_V21/" # wofry simulations
    dir_out = "/scisoft/users/srio/MLCRL/V20/ML_TRAIN2_V21/12500/"  # CNN data
    only1000 = False


    model_root = "training_v21"
