...
if __name__ == "__main__":
    ...
    dir_wofrydata = "/scisoft/users/srio/MLCRL/V25/wofry_results/"
    dir_out =       "/scisoft/users/srio/MLCRL/V25/"  # where the results are going to be written
    only1000 = False
    ...
    if do_plot: plot(epochs, val_acc_values,
         epochs, acc_values,
